...
\subfloat[Architecture overview]{%
  \includegraphics[width=0.48\textwidth]{img/data-architecture.png}%
  \label{fig:data-architecture}%
}
\hfill
\subfloat[ESP32-based sensing prototype]{%
  \includegraphics[width=0.48\textwidth]{img/cicuit-sensors.png}%
  \label{fig:prototype}%
}
...
\subfloat[Instrumented platform]{%
  \includegraphics[width=0.48\textwidth]{img/motocycle.png}%
  \label{fig:motorcycle}%
}
\hfill
\subfloat[Routes by mode]{%
  \includegraphics[width=0.48\textwidth]{img/map-eco.png}%
}
\\[-0.2em]
\subfloat[]{%
